<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Verifikasi & Laporan</span>
    </li>
    <li class="menu-item">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="Authentications">Table Akun</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="?us=tableUser" class="menu-link">
            <div data-i18n="Basic">Masyarakat</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="?us=tablePetugas" class="menu-link">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
          <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
            ...
            <?php $akunmas = mysqli_query($conn, "SELECT * FROM masyarakat ORDER BY nik DESC LIMIT 1");
            $akun = mysqli_fetch_assoc($akunmas);
            ?>
            <span class="badge bg-danger rounded-pill badge-notifications"><?php if ($akun == 0) {
                                                                              echo "";
                                                                            } else if ($akun > 0) {
                                                                              echo "1";
                                                                            } ?></span>
          ...
          <ul class="dropdown-menu dropdown-menu-end py-0">
            <li class="dropdown-menu-header border-bottom">
              <div class="dropdown-header d-flex align-items-center py-3">
                ...
                <a href="#" class="dropdown-notifications-all text-body" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark all as read"><i class="bx fs-4 bx-envelope-open"></i></a>
              </div>
                ...
                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <p class="mb-0">Baru Saja Mendaftar</p>
              ...
              <a class="dropdown-item" href="">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    ?>
                    <span class="fw-semibold d-block"><?= ucwords($_SESSION['username_admin']) ?></span>
